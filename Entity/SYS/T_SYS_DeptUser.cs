...
namespace Entity.SYS
{
    ...
    public class  T_SYS_DeptUser : TEntityBase
    {
          ...
          private string _F_DeptSN;
        
          /// <summary>
           /// </summary>
          public string F_DeptSN{get{return _F_DeptSN;}set{ if(_F_DeptSN!=value){_F_DeptSN=value;if(SendNotifyProperty)this.SendPropertyChanged("F_DeptSN");}}}
