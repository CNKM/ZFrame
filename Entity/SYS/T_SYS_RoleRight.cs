...
namespace Entity.SYS
{
    ...
    public class  T_SYS_RoleRight : TEntityBase
    {
          ...
          private Guid _F_RightSN;
        
          /// <summary>
           /// </summary>
          public Guid F_RightSN {get{return _F_RightSN;}set{ if(_F_RightSN!=value){_F_RightSN=value;if(SendNotifyProperty)this.SendPropertyChanged("F_RightSN");}}}
